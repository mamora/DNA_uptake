...
isolated.uss.10.list<-read.csv("C:/Users/marcelo/Dropbox/uptake/Final_resources/R_scripts/peak finder/output/lists/isolated.uss.10.list.csv")
...
dist.end<- (max(Uptake.uss.10.list$keypos) - length(uptake$pos))  #calculate distance from last USS in the genome to the position 1
