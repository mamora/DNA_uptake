...
knitr::opts_knit$set(root.dir = 'C:/Users/marcelo/Dropbox/uptake/Uptake_summer2017/')
...
x<- split_pos(uptake = Uptake.ratio.np)   #split the uptake file for positions
y<- split_ratio(uptake = Uptake.ratio.np) #split the uptake file for ratios
...
write.csv(peak.list.all, "./datasets/peak.list.all.csv")
