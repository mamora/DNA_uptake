...
p0 <- ggplot(aes(x = bases, y =rel_mol, color = sample), data = d.df) +
  geom_smooth(method = "loess", span = 0.2) + #span controls the amount of smoothing
  scale_x_continuous(limits = c(1000,15000), expand = c(0, 0))+
...
ggsave("C:/Users/marcelo/Dropbox/uptake/Everything_else/Bioanalyzer images/large.png", width = 50, height = 30, units = "cm")  
...
ggsave("C:/Users/marcelo/Dropbox/uptake/Everything_else/Bioanalyzer images/small.png", width = 50, height = 30, units = "cm")  
