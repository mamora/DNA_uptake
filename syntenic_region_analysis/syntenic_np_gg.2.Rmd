...
m3.up.np<- Uptake.ratio.np[m[3,1]:m[3,50000],]
m3.up.gg<- Uptake.ratio.gg[m[4,1]:m[4,50000],]
...
file_name = paste("C:/Users/marcelo/Dropbox/uptake/Uptake_summer2017/Figures/Uptake_maps/short.ratio.np.syntenic","50kb", "tiff", sep=".")
...
p <- ggplot() +
  ...
  theme(plot.margin=unit(c(1,1,1,1),"cm"),
        ...
        axis.text  = element_text(size=18),
        axis.title = element_text(size = 18, face = "bold")) 
file_name = paste("C:/Users/marcelo/Dropbox/uptake/Uptake_summer2017/Figures/Uptake_maps/short.ratio.gg.syntenic","50kb", "tiff", sep=".")
tiff(file_name, width = 800, height = 500, units = "px")
print(p)
dev.off()
