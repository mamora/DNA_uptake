...
uptake_first_pos <- function(focal, USS_list = USS_list, L = L, b0 = Baseline_binding, u0 = Baseline_uptake ){
  ...
  separ <- rep(0, L)         # Create an empty vector for USS10 separation.                       
  ...
  # from the Uptake_table. and calculates p_taken_up as the mean of thes  uptake probabilities.
