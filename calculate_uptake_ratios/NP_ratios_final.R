...
#############################load dataframes##############################
remix13.UP01<- fread("C:/Users/marcelo/Dropbox/uptake/Uptake_summer2017/REMIX_files/all/REMIX13.UP01.I.np.depth.bed") #load new input samples fro UP01   
...
samples.np<- fread("C:/Users/marcelo/Dropbox/uptake/Uptake_summer2017/REMIX_files/all/samples.all.np.bed.csv") #load all samples from NP donor DNA, input included
...
#############################normalization#### ##########################
up13.up01.mapped<- (2856940 + 2856729 + 2856666 + 2856522)/4    # total mapped reads, from sambamba flagstats files 
up01.all.mapped<- 2657457 # total mapped reads from summary table
remix13.UP01$UP01.n<- (remix13.UP01$UP01 *1e+6)/up01.all.mapped
remix13.UP01$input.n<- (remix13.UP01$input.mean *1e+6)/up13.up01.mapped
...
#############################load dataframes##############################
remix13.UP02<- fread("C:/Users/marcelo/Dropbox/uptake/Uptake_summer2017/REMIX_files/all/REMIX13.UP02.I.np.depth.bed") #load new input samples for UP02   
...
##Normalize the raw reads to depth per millon reads##
#############################normalization##############################
up13.up02.mapped<- (2920245 + 2920076 + 2920053 +2920052)/4 # total mapped reads, from sambamba flagstats files 
up02.all.mapped<- 2399436 # total mapped reads from summary table
remix13.UP02$UP02.n<- (remix13.UP02$UP02 *1e+6)/up02.all.mapped
remix13.UP02$input.n<- (remix13.UP02$input.mean *1e+6)/up13.up02.mapped
...
#############################load dataframes##############################
remix13.UP03<- fread("C:/Users/marcelo/Dropbox/uptake/Uptake_summer2017/REMIX_files/all/REMIX13.UP03.I.np.depth.bed") #load new input samples for UP03   
...
##Normalize the raw reads to depth per millon reads##
#############################normalization##############################
up13.up03.mapped<- (2961910  + 2961887  + 2962178  + 2962202)/4 # total mapped reads, from sambamba flagstats files 
up03.all.mapped<- 2973021 # total mapped reads from summary table
remix13.UP03$UP03.n<- (remix13.UP03$UP03 *1e+6)/up03.all.mapped
remix13.UP03$input.n<- (remix13.UP03$input.mean *1e+6)/up13.up03.mapped
...
#############################load dataframes##############################
remix15.UP07<- fread("C:/Users/marcelo/Dropbox/uptake/Uptake_summer2017/REMIX_files/all/REMIX15.UP07.I.np.depth.bed") #load new input samples fro UP07   
...
##Normalize the raw reads to depth per millon reads##
#############################normalization##############################
up15.up07.mapped<- (5108126 + 5107971 + 5107805 + 5108155)/4 # total mapped reads, from sambamba flagstats files 
up07.all.mapped<- 5098008 # total mapped reads from summary table
remix15.UP07$UP07.n<- (remix15.UP07$UP07 *1e+6)/up07.all.mapped
remix15.UP07$input.n<- (remix15.UP07$input.mean *1e+6)/up15.up07.mapped
...
#############################load dataframes##############################
remix15.UP08<- fread("C:/Users/marcelo/Dropbox/uptake/Uptake_summer2017/REMIX_files/all/REMIX15.UP08.I.np.depth.bed") #load new input samples fro UP08  
...
##Normalize the raw reads to depth per millon reads##
#############################normalization##############################
up15.up08.mapped<- (5617848  + 5616558 + 5616760 + 5616736)/4  # total mapped reads, from sambamba flagstats files 
up08.all.mapped<- 3671176 # total mapped reads from summary table
remix15.UP08$UP08.n<- (remix15.UP08$UP08 *1e+6)/up08.all.mapped
remix15.UP08$input.n<- (remix15.UP08$input.mean *1e+6)/up15.up08.mapped
...
#############################load dataframes##############################
remix15.UP09<- fread("C:/Users/marcelo/Dropbox/uptake/Uptake_summer2017/REMIX_files/all/REMIX15.UP09.I.np.depth.bed") #load new input samples fro UP09   
...
##Normalize the raw reads to depth per millon reads##
#############################normalization##############################
up15.up09.mapped<- (5329774   + 5329320 + 5329723 + 5330343 )/4  # total mapped reads, from sambamba flagstats files 
up09.all.mapped<- 7177274 # total mapped reads from summary table
remix15.UP09$UP09.n<- (remix15.UP09$UP09 *1e+6)/up09.all.mapped
remix15.UP09$input.n<- (remix15.UP09$input.mean *1e+6)/up15.up09.mapped
...
# save
write.csv(norm.ratios.np, "~/DNA_uptake/datasets/tables/norm.ratios.np.csv")
